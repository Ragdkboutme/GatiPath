import { Clock, MapPin, User, Wifi, Activity } from "lucide-react";
    ...
    <header className="h-16 bg-card border-b border-border px-6 flex items-center justify-between shadow-panel">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">Traffic Operations Dashboard</p>
        </div>
      </div>
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm text-foreground">Delhi NCR — Junction Cluster 12</span>
        </div>
      </div>
